...
public class CheckRoomNum : MonoBehaviour {
    ...
    public void ResetRoomNum()
    {
        ...
        for (int i = 0; i < 6; i++)
        {
            JoinRoomNum.instance.RoomNum.GetChild(i).GetChild(0).GetComponent<Text>().text = "";
        }
    }
    ...
    public void DeleteRoomNum()
    {
        ...
        JoinRoomNum.instance.RoomNum.GetChild(numArrayList.Count-1).GetChild(0).GetComponent<Text>().text = "";
    ...
    public void ShowRoomNum()
    {
        ...
        {            
                JoinRoomNum.instance.RoomNum.GetChild(i).GetChild(0).GetComponent<Text>().text = numArrayList[i].ToString();
        }
    }
    ...
    public void CheckRoomNumRight()
    {
        if (numArrayList.Count==6)
        {
            ...
            CreateRoomViewMgr.m_Instance.joinRoomWindow.SetActive(false);
        }
    }
}
