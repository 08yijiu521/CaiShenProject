...
public class MainViewMgr : MonoBehaviour {
    ...
    public Text Label_RoomID;                //当前房间号
    public MainSceneMger.PlayerSeat m_MySeat;   //当前玩家座位

    public GameObject obj_IconDown;             //位于下方玩家的头像OBJ
    public Image Img_IconDown;               //位于下方的玩家头像图片
    public Text Label_Down;                  //位于下方的玩家金币Label
    public GameObject obj_IconLeft;             //位于左方玩家的头像OBJ
    public Image Img_IconLeft;               //位于左方的玩家头像图片
    public Text Label_Left;                  //位于左方的玩家金币Label
    public GameObject obj_IconUp;             //位于上方玩家的头像OBJ
    public Image Img_IconUp;               //位于上方的玩家头像图片
    public Text Label_Up;                  //位于上方的玩家金币Label
    public GameObject obj_IconRight;             //位于右方玩家的头像OBJ
    public Image Img_IconRight;               //位于右方的玩家头像图片
    public Text Label_Right;                  //位于右方的玩家金币Label
    ...
    public Button Btn_StartGame;              //开始游戏按钮
    ...
    public Image Img_DQDown;                //位于玩家下方的定缺图标
    public Image Img_DQRight;               //位于玩家右方的定缺图标
    public Image Img_DQUp;                  //位于玩家上方的定缺图标
    public Image Img_DQLeft;                //位于玩家左方的定缺图标
    ...
    public Button btn_WeChatRequire;
    public Transform m_CenterContain;
    [Header("流局")]
    public GameObject LiuJu = null;

    [Header("实时流水和提示按钮")]
    public Button Btn_realTimeScore;
    ...
    void InitBtn()
    { 
        btn_WeChatRequire.onClick.AddListener(() => { BtnWeChatRequireClick(btn_WeChatRequire.gameObject); });
    }
    /// <summary>
    /// 初始化玩家头像
    /// </summary>
            ...
            switch (m_MySeat)
            {
                case MainSceneMger.PlayerSeat.PlayerEast:
                    ...
                    else
                    {
                        ...
                        Img_IconDown.sprite.name = InitPlayerIcon(RoomInfoMgr.m_Instance.m_PlayerEastIconID);   //初始化玩家下方头像
                    ...
                    else
                    {
                        ...
                        Img_IconRight.sprite.name = InitPlayerIcon(RoomInfoMgr.m_Instance.m_PlayerSouthIconID);   //初始化玩家右边头像
                    ...
                    else
                    {
                        ...
                        Img_IconUp.sprite.name = InitPlayerIcon(RoomInfoMgr.m_Instance.m_PlayerWestIconID);   //初始化玩家上边头像
                    ...
                    else
                    {
                        ...
                        Img_IconLeft.sprite.name = InitPlayerIcon(RoomInfoMgr.m_Instance.m_PlayerNorthIconID);   //初始化玩家左边头像
                ...
                case MainSceneMger.PlayerSeat.PlayerSouth:
                    ...
                    else
                    {
                        ...
                        Img_IconLeft.sprite.name = InitPlayerIcon(RoomInfoMgr.m_Instance.m_PlayerEastIconID);   //初始化玩家左方头像
                    ...
                    else
                    {
                        ...
                        Img_IconDown.sprite.name = InitPlayerIcon(RoomInfoMgr.m_Instance.m_PlayerSouthIconID);   //初始化玩家下边头像
                    ...
                    {
                        obj_IconRight.SetActive(true);   //右边方头像显示
                        Img_IconRight.sprite.name = InitPlayerIcon(RoomInfoMgr.m_Instance.m_PlayerWestIconID);   //初始化玩家右边头像
                    ...
                    {
                        obj_IconUp.SetActive(true);   //上边方头像显示
                        Img_IconUp.sprite.name = InitPlayerIcon(RoomInfoMgr.m_Instance.m_PlayerNorthIconID);   //初始化玩家上边头像
                ...
                case MainSceneMger.PlayerSeat.PlayerWest:
                    ...
                    else
                    {
                        ...
                        Img_IconUp.sprite.name = InitPlayerIcon(RoomInfoMgr.m_Instance.m_PlayerEastIconID);   //初始化玩家上方头像
                    ...
                    {
                        obj_IconLeft.SetActive(true);   //左边方头像显示
                        Img_IconLeft.sprite.name = InitPlayerIcon(RoomInfoMgr.m_Instance.m_PlayerSouthIconID);   //初始化玩家左边头像
                    ...
                    {
                        obj_IconDown.SetActive(true);   //下边方头像显示
                        Img_IconDown.sprite.name = InitPlayerIcon(RoomInfoMgr.m_Instance.m_PlayerWestIconID);   //初始化玩家下边头像
                    ...
                    else
                    {
                        ...
                        Img_IconRight.sprite.name = InitPlayerIcon(RoomInfoMgr.m_Instance.m_PlayerNorthIconID);   //初始化玩家上边头像
                ...
                case MainSceneMger.PlayerSeat.PlayerNorth:
                    ...
                    else
                    {
                        ...
                        Img_IconRight.sprite.name = InitPlayerIcon(RoomInfoMgr.m_Instance.m_PlayerEastIconID);   //初始化玩家右方头像
                    ...
                    {
                        obj_IconUp.SetActive(true);   //上边方头像显示
                        Img_IconUp.sprite.name = InitPlayerIcon(RoomInfoMgr.m_Instance.m_PlayerSouthIconID);   //初始化玩家上边头像
                    ...
                    {
                        obj_IconLeft.SetActive(true);   //左边方头像显示
                        Img_IconLeft.sprite.name = InitPlayerIcon(RoomInfoMgr.m_Instance.m_PlayerWestIconID);   //初始化玩家左边头像
                    ...
                    {
                        obj_IconDown.SetActive(true);   //下边方头像显示
                        Img_IconDown.sprite.name = InitPlayerIcon(RoomInfoMgr.m_Instance.m_PlayerNorthIconID);   //初始化玩家下边头像
    ...
    public void initWaitInfo(RoomModel roomModel)
    {
        ...
        if (RoomInfoMgr.m_Instance!=null)
        {
            ...
            Wait_Down.GetComponentInChildren<Image>().sprite.name = "Img_Waiting";
            Wait_Right.GetComponentInChildren<Image>().sprite.name = "Img_Waiting";
            Wait_Up.GetComponentInChildren<Image>().sprite.name = "Img_Waiting";
            Wait_Left.GetComponentInChildren<Image>().sprite.name = "Img_Waiting";
        }
    }
    ...
    public void ActiveDingQueBtn()
    {
        ...
        Button[] btns = Btn_DingQueParent.GetComponentsInChildren<Button>();
        foreach(Button btn in btns)
        {
            btn.onClick.AddListener(() => { BtnDingQueClick(btn.gameObject); }); 
        }
    }
    /// <summary>
    /// 定缺按钮回调方法
    ...
    public void InitDingQueWaitingInfo(FightModel fightModel)
    {
        ...
        Wait_Down.GetComponentInChildren<Image>().sprite.name = "Img_dqz";
        Wait_Right.GetComponentInChildren<Image>().sprite.name = "Img_dqz";
        Wait_Up.GetComponentInChildren<Image>().sprite.name = "Img_dqz";
        Wait_Left.GetComponentInChildren<Image>().sprite.name = "Img_dqz";
    }
    /// <summary>
    /// 初始化定缺信息
    /// </summary>
        ...
        switch (m_MySeat)
        {
            case MainSceneMger.PlayerSeat.PlayerEast:
                ...
                if (fightModel.DongQue > 0)
                {
                    ...
                    Img_DQDown.sprite.name = GetImg_DQName(fightModel.DongQue);
                }
                if (fightModel.NanQue > 0)
                {
                    Img_DQRight.gameObject.SetActive(true);
                    Img_DQRight.sprite.name = GetImg_DQName(fightModel.NanQue);
                }
                if (fightModel.XiQue > 0)
                {
                    Img_DQUp.gameObject.SetActive(true);
                    Img_DQUp.sprite.name = GetImg_DQName(fightModel.XiQue);
                }
                if (fightModel.BeiQue > 0)
                {
                    Img_DQLeft.gameObject.SetActive(true);
                    Img_DQLeft.sprite.name = GetImg_DQName(fightModel.BeiQue);
                }
                break;
            case MainSceneMger.PlayerSeat.PlayerWest:
                ...
                {
                    Img_DQUp.gameObject.SetActive(true);
                    Img_DQUp.sprite.name = GetImg_DQName(fightModel.DongQue);
                }
                if (fightModel.NanQue > 0)
                {
                    Img_DQLeft.gameObject.SetActive(true);
                    Img_DQLeft.sprite.name = GetImg_DQName(fightModel.NanQue);
                }
                if (fightModel.XiQue > 0)
                {
                    Img_DQDown.gameObject.SetActive(true);
                    Img_DQDown.sprite.name = GetImg_DQName(fightModel.XiQue);
                }
                if (fightModel.BeiQue > 0)
                {
                    Img_DQRight.gameObject.SetActive(true);
                    Img_DQRight.sprite.name = GetImg_DQName(fightModel.BeiQue);
                }
                break;
            case MainSceneMger.PlayerSeat.PlayerSouth:
                PlayerManager.m_instance.m_EastPlayer.DingQue(GetDQType(fightModel.DongQue));
                ...
                {
                    Img_DQLeft.gameObject.SetActive(true);
                    Img_DQLeft.sprite.name = GetImg_DQName(fightModel.DongQue);
                }
                if (fightModel.NanQue > 0)
                {
                    Img_DQDown.gameObject.SetActive(true);
                    Img_DQDown.sprite.name = GetImg_DQName(fightModel.NanQue);
                }
                if (fightModel.XiQue > 0)
                {
                    Img_DQRight.gameObject.SetActive(true);
                    Img_DQRight.sprite.name = GetImg_DQName(fightModel.XiQue);
                }
                if (fightModel.BeiQue > 0)
                {
                    Img_DQUp.gameObject.SetActive(true);
                    Img_DQUp.sprite.name = GetImg_DQName(fightModel.BeiQue);
                }
                break;
            case MainSceneMger.PlayerSeat.PlayerNorth:
                PlayerManager.m_instance.m_EastPlayer.DingQue(GetDQType(fightModel.DongQue));
                ...
                {
                    Img_DQRight.gameObject.SetActive(true);
                    Img_DQRight.sprite.name = GetImg_DQName(fightModel.DongQue);
                }
                if (fightModel.NanQue > 0)
                {
                    Img_DQUp.gameObject.SetActive(true);
                    Img_DQUp.sprite.name = GetImg_DQName(fightModel.NanQue);
                }
                if (fightModel.XiQue > 0)
                {
                    Img_DQLeft.gameObject.SetActive(true);
                    Img_DQLeft.sprite.name = GetImg_DQName(fightModel.XiQue);
                }
                if (fightModel.BeiQue > 0)
                {
                    Img_DQDown.gameObject.SetActive(true);
                    Img_DQDown.sprite.name = GetImg_DQName(fightModel.BeiQue);
                }
                break;
        }
        //定缺结束,东家发信息
    ...
    public void ActiveGangBtn(bool isMingGang, BoutModel boutModel)
    {
        ...
        foreach (Button btn in Btn_Gang.GetComponentsInChildren<Button>())
        {
            btn.onClick.AddListener(() => { BtnPengGangHuGuoClick(btn.gameObject, boutModel.CurrentPlate, boutModel); }); 
        }
    }
    public void ActivePengBtn(BoutModel boutModel)
    {
        ...
        foreach (Button btn in Btn_Peng.GetComponentsInChildren<Button>())
        {
            btn.onClick.AddListener(() => { BtnPengGangHuGuoClick(btn.gameObject, boutModel.CurrentPlate, boutModel); }); 
        }
    }
    ...
    public void ActiveHuBtn(bool isZiMo, BoutModel boutModel)
    {
        ...
        foreach (Button btn in Btn_Hu.GetComponentsInChildren<Button>())
        {
            btn.onClick.AddListener(() => { BtnPengGangHuGuoClick(btn.gameObject, boutModel.CurrentPlate, boutModel); }); 
        }
    }
    ...
    public void ActiveHuPengBtn(BoutModel boutModel)
    {
        ...
        boutModel.HuType = 1;
        boutModel.LittleCanon = GetUpstream();
        foreach (Button btn in Btn_HuPeng.GetComponentsInChildren<Button>())
        {
    ...
    public void ActiveHuGangBtn(bool isZiMo,bool isMingGang,BoutModel boutModel)
    {
        ...
        boutModel.LittleCanon = GetUpstream();
        foreach (Button btn in Btn_HuGang.GetComponentsInChildren<Button>())
        {
            btn.onClick.AddListener(()=> { BtnPengGangHuGuoClick(btn.gameObject, boutModel.CurrentPlate, boutModel); });
